//
//  MugenQuizListView.swift
//  it
//
//  Created by Apple on 2024/06/12.
//

import SwiftUI

struct MugenQuizListView: View {
    ...
    init(isPresenting: Binding<Bool>) {  //初期化メソッドに user を追加
    ...
    var body: some View {
        MugenQuizView(quizzes: shuffledQuizList, quizLevel: .itBasic, authManager: authManager, audioManager: audioManager, isPresenting: $isPresenting, interstitial: sharedInterstitial)
    }
}

struct MugenQuizListView_Previews: PreviewProvider {
