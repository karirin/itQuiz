...
struct QuizIntermediateStoryList: View {
    ...
    var body: some View {
        QuizView(quizzes: shuffledQuizList, quizLevel: .beginnerStory2, authManager: authManager,audioManager: audioManager,isPresenting: $isPresenting, interstitial: sharedInterstitial)
    }
}

struct QuizIntermediateStoryList_Previews: PreviewProvider {
    static var previews: some View {
        QuizIntermediateStoryList(isPresenting: .constant(false))
    }
}
