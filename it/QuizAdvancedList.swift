...
struct QuizAdvancedList: View {
    ...
    let QuizAdvancedList: [QuizQuestion] = [
        ...
        QuizQuestion(
        question: "オンチャネルとオフチャネルの主な違いは何ですか？",
        choices: [
        "オンチャネルはブロックチェーン上で、オフチャネルはブロックチェーン外で行われる",
        "オンチャネルは暗号化され、オフチャネルは暗号化されない",
        "オンチャネルは公開され、オフチャネルは非公開",
        "オンチャネルはスマートコントラクト、オフチャネルは通常のトランザクション"
        ],
        correctAnswerIndex: 0,
        explanation: "オンチャネルトランザクションはブロックチェーン上で行われ、オフチャネルトランザクションはブロックチェーン外で行われます。"
        ),
