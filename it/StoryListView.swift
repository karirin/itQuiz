...
struct StoryListView: View {
    ...
    var body: some View {
        StoryQuizView(viewModel: viewModel, quizzes: shuffledQuizList, quizLevel: .itBasic, monsterName: monsterName, backgroundName: backgroundName, authManager: authManager, audioManager: audioManager, isPresenting: $isPresenting, interstitial: sharedInterstitial)
            .onAppear{
                print("モンスター    stroy:\(monsterName)")
                print("背景   stroy:\(backgroundName)")
            }
    }
}

struct StoryListViewView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        StoryListView(isPresenting: .constant(false), monsterName: "モンスター1", backgroundName: "背景1", viewModel: PositionViewModel())
    }
}
