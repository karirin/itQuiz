...
struct TittlesView: View {
    ...
    let allTitles: [TitleItem] = [
        ...
        TitleItem(name: "連続ログイン7日", titleName: "七日皆勤", description: "7日連続ログインを達成したことを讃える称号", rarity: .bronze),
        TitleItem(name: "連続ログイン30日", titleName: "月間ストリーカー", description: "30日連続ログインを達成したことを讃える称号", rarity: .gold),
        TitleItem(name: "連続ログイン100日", titleName: "百日レジェンド", description: "100日連続ログインを達成したことを讃える称号", rarity: .diamond),
