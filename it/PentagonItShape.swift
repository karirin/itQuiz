...
//}
//
//extension QuizLevelIt: CaseIterable {
//    static var allCases: [QuizLevelIt] {
//        return [.beginner, .intermediate, .advanced, .god, .network, .database]
//        // 除外したいケースをここで除外
//    }
//}
//
//struct PentagonGraphItShape: Shape {
//    var quizData: [QuizLevelIt: QuizData]
//
...
//        var path = Path()
//
//        for (i, level) in QuizLevelIt.allCases.enumerated() {
...
////}
//
//struct PentagonGraphLabelItView: View {
//    var label: String
//    var index: Int
...
//    var body: some View {
//        GeometryReader { geometry in
//            let angle = (2 * CGFloat.pi) / CGFloat(QuizLevelIt.allCases.count) * CGFloat(index) - .pi / 2
//            let center = CGPoint(x: geometry.size.width / 2, y: geometry.size.height / 2)
...
//
//
//struct PentagonGraphBackgroundItShape: Shape {
//    func path(in rect: CGRect) -> Path {
//        let center = CGPoint(x: rect.midX, y: rect.midY)
...
//
//
//struct PentagonGraphItView: View {
//    @State private var quizData = [QuizLevelIt: QuizData]()
//    let userId: String
//    let labels: [String]
//    
...
//
//                ZStack {
//                    PentagonGraphBackgroundItShape()
//                                    .stroke(Color.gray, lineWidth: 1)
//                    PentagonGraphItShape(quizData: quizData)
...
//                           )
//
//                    ForEach(Array(QuizLevelIt.allCases.enumerated()), id: \.offset) { (i, _) in
//                        PentagonGraphLabelItView(label: labels[i], index: i)
//                    }
//                    // 目盛りの数字を表示する
...
//                    }
////                    RateManager.shared.fetchQuizData(userId: userId) { data in
////                        var convertedData = [QuizLevelIt: QuizData]()
////                        for (key, value) in data {
////                            if let convertedKey = QuizLevelIt(rawValue: key.rawValue) {
////                                convertedData[convertedKey] = value
////                            }
////                        }
////                        self.quizData = convertedData
////                    }
//
//                }
//            }
...
////            }
////            .padding(.top)
//            PentagonGraphItView(userId: authManager.currentUserId!, labels: ["初級", "中級", "上級", "神級", "ネットワーク", "セキュリティ","データベース"])
//                .padding(.top,50)
//            VStack(spacing: 0) {
//                HStack{
...
//                .padding()
//                ScrollView{
//                    ForEach(QuizLevelIt.allCases, id: \.self) { level in
...
//}
//
//struct PentagonShapeIT_Previews: PreviewProvider {
