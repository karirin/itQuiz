...
//
    ...
    var body: some View {
        QuizBossView(quizzes: shuffledQuizList, quizLevel: .shinjyu, authManager: authManager, audioManager: audioManager, isPresenting: $isPresenting, interstitial: sharedInterstitial)
    }
}

struct QuizShinjyuList_Previews: PreviewProvider {
    static var previews: some View {
        QuizShinjyuList(isPresenting: .constant(false))
    }
}
