...
struct StoryUserQuizListView: View {
    ...
    init(isPresenting: Binding<Bool>,viewModel: PositionViewModel,user: User, backgroundName: String) {  //初期化メソッドに user を追加
    ...
    var body: some View {
        StoryUserQuizView(quizzes: shuffledQuizList, quizLevel: .itBasic, backgroundName: backgroundName, authManager: authManager, viewModel: viewModel, audioManager: audioManager, isPresenting: $isPresenting, interstitial: sharedInterstitial, user: user)
    }
}

struct StoryUserQuizListView_Previews: PreviewProvider {
