...
//
    ...
    var body: some View {
        QuizBossView(quizzes: shuffledQuizList, quizLevel: .kaijyu, authManager: authManager, audioManager: audioManager, isPresenting: $isPresenting, interstitial: sharedInterstitial)
    }
}

struct QuizKaijyuList_Previews: PreviewProvider {
    static var previews: some View {
        QuizKaijyuList(isPresenting: .constant(false))
    }
}
